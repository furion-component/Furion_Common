/**
 * Copyright (c) 2013-Now http://huibur.com All rights reserved.
 */
package com.huibur.furion.common.util.excel;

import com.fasterxml.jackson.annotation.JsonFormat;
import com.huibur.furion.common.codec.EncodeUtils;
...
import com.huibur.furion.common.reflect.ReflectUtils;
import com.huibur.furion.common.util.excel.annotation.ExcelField;
import com.huibur.furion.common.util.excel.annotation.ExcelField.Align;
import com.huibur.furion.common.util.excel.annotation.ExcelField.Type;
import com.huibur.furion.common.util.excel.annotation.ExcelFields;
		...
		try {
			if(val == null){
				...
				if(val instanceof String) {
					...
					// 如果没有指定 fieldType，切自行根据类型查找相应的转换类（com.huibur.furion.common.util.excel.fieldtype.值的类名+Type）
			...
			for (Object[] os : annotationList){
				...
				try{
					...
					if (StringUtils.isNotBlank(ef.dictType())){
						Class<?> dictUtils = Class.forName("com.huibur.modules.sys.util.DictUtils");
